package com.mdground.screen.utils.mail;
...
public class MailManager {
    private static final String SENDER_NAME = "zhongshiran77@163.com";
    private static final String SENDER_PASS = "VWGQBACEHMJUHCCM";
...
//                return new PasswordAuthentication(SENDER_NAME, SENDER_PASS.toCharArray());
//            }
//        };
//    }
    ...
    private MimeMessage createMessage(String title, String content) {
        ...
        Session session = Session.getInstance(properties, new javax.mail.Authenticator() {
            ...
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new javax.mail.PasswordAuthentication(SENDER_NAME,SENDER_PASS);
            }
        });
