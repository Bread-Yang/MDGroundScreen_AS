...
public class IflyTetTTsMainActivity extends BaseActivity {
    ...
    private String TAG = "IflyTetTTsMainActivity";
...
//							Log.e("gridView.getHeight()/4"+TAG,gridView.getHeight()/4+"");
//							Log.e("gridView.getWidth()/3"+TAG,gridView.getWidth()/3*2+"");
//
//							gridView.setRowHeight(gridView.getHeight()/4);
//							gridView.setColumnWidth(gridView.getWidth()/3*2);
    ...
    class NumAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //Log.e("IflyTetTTsMainActivity:optype:" + appointment.getOPType(), "opstatus:" + appointment.getOPStatus());
